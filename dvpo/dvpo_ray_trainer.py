...
"""
DVPO Ray Trainer - Modified PPO trainer with distributional value estimation
"""
...
def compute_distributional_advantage(
    data: DataProto,
    adv_estimator,
    gamma=0.99,
    lam=0.95,
    ...
    return data, returns, advantages


class RayDVPOTrainer(RayPPOTrainer):
    """
    DVPO Ray Trainer - Extends PPO trainer with distributional value estimation
    """

    def compute_kl_related_metrics(self, batch: DataProto, metrics: dict, timing_raw: dict):
        """
        Override to handle distributional critic outputs
        """
    ...
    def fit(self):
        """
        The training loop of DVPO.
        Modified from PPO to use distributional critic and GAE.
        """
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # compute values using distributional critic
                    if self.use_critic:
                    ...
                    with marked_timer("adv", timing_raw, "brown"):
                        # compute advantages using distributional GAE
                        batch, returns, advantages = compute_distributional_advantage(
                            batch,
